<x-master-layout name="ApplicantRecord" headerName="{{ __('sidebar.applicantRecord') }}">
    <x-form.layout>
        <form action="{{ route('applicantRecords.store') }}" method="post">
            @csrf
            <x-form.fieldset title="Application Detail">
                <x-form.grid>
            ...
            <x-form.fieldset title="Exam Records" :openTag="false">
                ...
                <x-form.grid>
                    ...
                    @endphp
                <x-form.input_group type="number" title="applicantRecord.sub_1" name="sub_1" labelID="lab-sub-1" placeholder="enter_mark" />
                <x-form.input_group type="number" title="applicantRecord.sub_2" name="sub_2" labelID="lab-sub-2" placeholder="enter_mark" />
                <x-form.input_group type="number" title="applicantRecord.sub_3" name="sub_3" labelID="lab-sub-3" placeholder="enter_mark" />
                <x-form.input_group type="number" title="applicantRecord.sub_4" name="sub_4" labelID="lab-sub-4" placeholder="enter_mark" />
                <x-form.input_group type="number" title="applicantRecord.sub_5" name="sub_5" labelID="lab-sub-5" placeholder="enter_mark" />
                <x-form.input_group type="number" title="applicantRecord.sub_6" name="sub_6" labelID="lab-sub-6" placeholder="enter_mark" />            
                </x-form.grid>
            </x-form.fieldset>
            <x-form.fieldset title="Program Records" :openTag="false">
                <x-form.grid>
            ...
            <x-form.fieldset title="Essay,Mental and Activity" :openTag="false">
                <x-form.grid>
